...
const FoodInfo: React.FC<FoodInfoProps> = props => (
  <View style={styles.infoContainer}>
    <Text style={styles.titleContainer}>{props.food.title}</Text>
...
const FoodImage: React.FC<FoodImageProps> = props => (
  <View>
    <Image source={{uri: props.food.image}} style={styles.foodImageContainer} />
  </View>
);
...
const styles = StyleSheet.create({
  ...
  foodImageContainer: {width: 100, height: 100, borderRadius: 8},
  checkBoxContainer: {
